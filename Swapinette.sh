...
### Première boucle : vérification du nombre d'opérations
echo "➤ Test 1 : Vérification du nombre d'opérations..."
...
### Deuxième boucle : vérification avec le checker choisi
echo -e "\n➤ Test 2 : Vérification avec $checker..."
